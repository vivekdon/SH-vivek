...
public class FutureMainController extends MultiActionController{
...
//		List<EquityDataDto> tableList=dataRetrivalService.getEquityTableData(sector,symbol,high52,limit);
