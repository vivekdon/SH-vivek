/*
function genType(d) {
alert(d.valueDate+':'+d.lowVal+':'+d.highVal  +':'+d.openVal   +':'+d.closeVal  +':'+d.tradeVal +':'+d.volume);	
  d.TIMESTAMP  = parseDate(d.valueDate);
  d.LOW        = +d.lowVal;
  d.HIGH       = +d.highVal; 
  d.OPEN       = +d.openVal;
  d.CLOSE      = +d.closeVal;
  d.TURNOVER   = +d.tradeVal;
  d.VOLATILITY = +d.volume;
  return d;
}
*/
function genType(d) {
//alert(d.TIMESTAMP+':'+d.LOW+':'+d.HIGH  +':'+d.OPEN   +':'+d.CLOSE  +':'+d.TURNOVER +':'+d.VOLATILITY);	
